...
invoke_target 是 Go Redis 作业类型（与 queue_type 相同）。
...
ANALYSIS_JOBS: tuple[AnalysisJobSpec, ...] = (
    AnalysisJobSpec(
        ...
        invoke_target='sentiment_collect',
        default_cron='0 0/10 * * * ?',
    ...
    AnalysisJobSpec(
        ...
        invoke_target='finance_briefings',
        default_cron='0 15 * * * ?',
    ...
    AnalysisJobSpec(
        ...
        invoke_target='position_monitor',
        default_cron='0 0/10 * * * ?',
        schedule_label='每 10 分钟',
        heavy=False,
    ...
    AnalysisJobSpec(
        ...
        invoke_target='indicator_refresh',
        default_cron='0 0/15 * * * ?',
    ...
    AnalysisJobSpec(
        ...
        invoke_target='watchlist_analyze',
        default_cron='0 20 * * * ?',
    ...
    AnalysisJobSpec(
        ...
        invoke_target='market_heat_collect',
        default_cron='0 5 7 * * ?',
