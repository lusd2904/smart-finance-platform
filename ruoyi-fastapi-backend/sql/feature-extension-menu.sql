...
('2130', '标的股票池', '2100', '5', 'stock-pool', 'market/stock-pool/index', '', 'MarketStockPool', 1, 0, 'C', '0', '0', 'market:instrument:list', 'list', 'admin', sysdate(), '', null, '标的股票池'),
('2131', '智能推荐', '2100', '6', 'recommendations', 'market/recommendations/index', '', 'MarketRecommendations', 1, 0, 'C', '0', '0', 'market:finance:list', 'star', 'admin', sysdate(), '', null, '智能推荐'),
