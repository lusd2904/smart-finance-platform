...
('2123', '行情覆盖', '2100', '10', 'coverage', 'market/coverage/index', '', 'MarketCoverage', 1, 0, 'C', '0', '0', 'market:kline:list', 'redis', 'admin', sysdate(), '', null, '行情历史覆盖'),
('2124', '高级图表', '2100', '11', 'tradingview', 'market/tradingview/index', '', 'MarketTradingview', 1, 0, 'C', '0', '0', 'market:kline:list', 'chart', 'admin', sysdate(), '', null, '高级图表'),
