...
@pytest.mark.asyncio
async def test_quote_kline_skips_realtime_on_daily_even_when_influx_empty() -> None:
    from module_market.service.market_service import MarketService
    from module_quant.service.longbridge_service import LongbridgeService
    from module_trade.service.trade_service import TradeService
...
@pytest.mark.asyncio
async def test_quote_kline_minute_fetches_realtime_only_when_influx_empty() -> None:
    from module_market.service.market_service import MarketService
    from module_quant.service.longbridge_service import LongbridgeService
    from module_trade.service.trade_service import TradeService
