...
(105, '全市场因子日扫', 'default', 'default', 'factor_scan', NULL, NULL, '0 10 6 * * ?', '3', '1', '0', 'admin', sysdate(), '', NULL, '每日收盘后计算 Alpha101/158 与 8 大因子族并写入读模型快照'),
(106, '持仓止损监控', 'default', 'default', 'position_monitor', NULL, NULL, '0 0/10 * * * ?', '3', '1', '0', 'admin', sysdate(), '', NULL, '每 10 分钟检查持仓浮亏，超阈值写入风控事件'),
(107, '行情指标快照刷新', 'default', 'default', 'indicator_refresh', NULL, NULL, '0 0/15 * * * ?', '3', '1', '0', 'admin', sysdate(), '', NULL, '每 15 分钟刷新目标池最新价与涨跌快照');
